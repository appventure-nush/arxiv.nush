          ...
          <v-form fast-fail @submit.prevent>
            <v-row>
              <v-col cols='12' md="4">
                ...
                <v-text-field label="Submission Code" v-model="code"
                  :rules="codeRules"
                  hint="Code allocated to you (e.g. BE023). If none is provided, input your project code." required></v-text-field>
              </v-col>
              <v-col cols="12" md="8">
                <v-autocomplete
                  v-model="projects"
              ...
              <v-col cols='12' md="6">
                ...
                <v-combobox label="Submission Title" v-model="subTitle"
                  :rules="titleRules"
                  :items="projects.map(it => it.title)"
                  hint="" required></v-combobox>
              </v-col>
              <v-col cols="12" md="6">
                <v-autocomplete
                  v-model="authors"
  ...
  methods: {
    async submit() {
      ...
      await createSubmission(
        this.event.eventId, this.event.year,
        this.code, this.subTitle, this.subAbstract,
