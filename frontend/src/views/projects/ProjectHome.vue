  ...
  <v-container fluid>
    ...
    <div class="mx-auto pa-4" height="100%">
      <div class="mx-4 d-flex">
        <h1>Your Projects</h1>
      <v-spacer />
          <v-btn color="primary" @click="newProjectVisible = true;" class="mx-4 x-large">Create New Project</v-btn>
...
function searchProjects(): Project[] {
  return projectSearch.value.length == 0 ? projects.value : fuzzysort.go(projectSearch.value, projects.value.map(
  (it) => {
    return {
      ...it,
